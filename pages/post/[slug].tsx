...
function Post({ post }: Props) {
  ...
  return (
    <main>
        ...
        <article className="max-w-3xl mx-auto p-5">
            ...
            <div className="flex items-center space-x-2">
                <img 
                    ...
                    alt=""
                />
                <p className="extralight text-sm">
                    Blogpost by {""}
        ...
        {submitted ? (
            <div className="flex flex-col p-10 my-10 border bg-yellow-500 text-white
            max-w-2xl mx-auto">
            ...
            {/*Errors will return when the validation field fails */}
            <div className="flex fleex-col p-5">
                {errors.name && (
